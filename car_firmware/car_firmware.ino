...
ACB_SmartCar_V2 ACB_SmartCar; //car
...
void setup()
{
    ...
    ACB_SmartCar.Init();  // Initialize Acebott
    ...
    ACB_SmartCar.Move(Stop, 0);  // Stop the Acebott exercise
    delay(3000); 
...
void model2_func()      // OA
{
    ...
    if (middleDistance <= 25) 
    {
        ...
        {
            ACB_SmartCar.Move(Backward, 180);
            ...
            ACB_SmartCar.Move(Contrarotate, 180);//delay(200);
            for(int i = 0;i < 500;i++)
            {
                delay(1);
                Receive_data();
        ...
        else if(rightDistance > leftDistance)
        {
            ...
            ACB_SmartCar.Move(Clockwise, 180);//delay(200);
            for(int i = 0;i < 500;i++)
            {
                delay(1);
                Receive_data();
...
void model3_func()      // follow model
{
    ...
    if (UT_distance < 15)
    {
        ACB_SmartCar.Move(Backward, 200);
    }
    ...
    {
        ACB_SmartCar.Move(Forward, speeds-70);
    }
    else if (25 <= UT_distance && UT_distance <= 50)
    {
        ACB_SmartCar.Move(Forward, 220);
    }
    else
    {
        ACB_SmartCar.Move(Stop, 0);
...
void model4_func()      // tracking model2
{
    ...
    {
        ACB_SmartCar.Move(Contrarotate, 150);
    }*/
    else if (Left_Tra_Value >= Black_Line && Center_Tra_Value < Black_Line && Right_Tra_Value < Black_Line)
    {
        ACB_SmartCar.Move(Contrarotate, 220);
    }
    else if (Left_Tra_Value < Black_Line && Center_Tra_Value < Black_Line && Right_Tra_Value >= Black_Line)
    {
        ACB_SmartCar.Move(Clockwise, 220);
    }
    /*else if (Left_Tra_Value < Black_Line && Center_Tra_Value >= Black_Line && Right_Tra_Value >= Black_Line)
    {
        ACB_SmartCar.Move(Clockwise, 150);
    }*/
...
void runModule(int device)
{
  ...
  switch(device) 
  {
    ...
    {   
      ...
      {
        case 0x01:
            ACB_SmartCar.Move(Forward, speeds);
            break;
        case 0x02:
            ACB_SmartCar.Move(Backward, speeds);
            break;
        case 0x03:
            ACB_SmartCar.Move(Move_Left, speeds);
            break;
        case 0x04:
            ACB_SmartCar.Move(Move_Right, speeds);
            break;
        case 0x05:
            ACB_SmartCar.Move(Top_Left, speeds);
            break;
        case 0x06:
            ACB_SmartCar.Move(Bottom_Left, speeds);
            break;
        case 0x07:
            ACB_SmartCar.Move(Top_Right, speeds);
            break;
        case 0x08:
            ACB_SmartCar.Move(Bottom_Right, speeds);
            break;
        case 0x0A:
            ACB_SmartCar.Move(Clockwise, speeds);
            break;
        case 0x09:
            ACB_SmartCar.Move(Contrarotate, speeds);
            break;
        case 0x00:
            ACB_SmartCar.Move(Stop, 0);
            break;
